...
public class PreferencesRules extends PreferenceActivity {
    ...
    private static class OnRuleClickListener implements OnPreferenceClickListener {
        ...
        public boolean onPreferenceClick(final Preference preference) {
            try {
                ...
                b.setPositiveButton(R.string.import_, (dialog, which) ->
                ...
                if (link != null) {
                    b.setNeutralButton(R.string.import_link_, (dialog, which) ->
                            OnRuleClickListener.this.c.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(link))));
                }
                b.show();
                return true;
            } catch (JSONException e) {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        try {
            JSONObject json = new JSONObject(Objects.requireNonNull(getIntent().getStringExtra(EXTRA_JSON)));
