...
public final class CVListPreference extends ListPreference {
     ...
     */
    @NonNull
    public Cursor setCursor(@NonNull final Cursor c, final int value, final int name) {
        int l = c.getCount();
    ...
    protected void onPrepareDialogBuilder(final Builder builder) {
        if (m) {
            builder.setMultiChoiceItems(getEntries(), checked, (dialog, which, val) ->
    ...
    protected View onCreateView(final ViewGroup parent) {
        ...
        TextView tv = v.findViewById(android.R.id.summary);
        if (tv != null) {
