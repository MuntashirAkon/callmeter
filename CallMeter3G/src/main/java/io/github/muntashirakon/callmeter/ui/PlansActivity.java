...
public final class PlansActivity extends AppCompatActivity implements OnPageChangeListener {
    ...
    private static class PlansFragmentAdapter extends FragmentPagerAdapter {
         ...
         */
        public PlansFragmentAdapter(@NonNull final Context context, final FragmentManager fm) {
            ...
            if (c == null || !c.moveToFirst()) {
                ...
                if (minDate < 0L || c == null || !c.moveToFirst()) {
                    ...
                    list.add(-1L); // logs
                    positions = list.toArray(new Long[0]);
         ...
         */
        public Fragment getActiveFragment(@NonNull final ViewPager container, final int position) {
