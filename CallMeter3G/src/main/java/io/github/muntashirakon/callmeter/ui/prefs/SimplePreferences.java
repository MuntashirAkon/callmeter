 ...
 * @author flx
 */
public final class SimplePreferences extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    private static void loadPrefsCall(final Editor e, @NonNull final ContentResolver cr,
    ...
    static void loadPrefs(final Context context) {
        ...
        // common
        Cursor c = cr
                .query(DataProvider.Plans.CONTENT_URI, DataProvider.Plans.PROJECTION, SELECTION_TYPE,
