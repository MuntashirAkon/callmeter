...
import io.github.muntashirakon.callmeter.ui.prefs.UpDownPreference.OnUpDownClickListener;
...
//    /** Tag for output. */
    ...
    public boolean onPreferenceClick(@NonNull final Preference preference) {
        ...
        if (k != null && k.startsWith("group_")) {
            ...
            builder.setItems(R.array.dialog_edit_delete, (dialog, which) -> {
                switch (which) {
                    case WHICH_EDIT:
                    ...
                    case WHICH_DELETE:
                        ...
                        b.setPositiveButton(android.R.string.yes, (dialog1, which1) -> {
                            Plans.this.getContentResolver().delete(ContentUris.withAppendedId(
                                    DataProvider.Plans.CONTENT_URI, id), null, null);
                            Plans.this.reload();
