...
public final class RuleMatcher {
    ...
    private static class Rule {
        ...
        static NumbersGroup[] getNumberGroups(final ContentResolver cr, final String gids) {
            ...
            return list.toArray(new NumbersGroup[0]);
        }
        ...
        static HoursGroup[] getHourGroups(final ContentResolver cr, final String gids) {
            ...
            return list.toArray(new HoursGroup[0]);
        }
        ...
        private static final class NumbersGroup {
             ...
             */
            private NumbersGroup(@NonNull final ContentResolver cr, final long what0) {
             ...
             */
            boolean match(@NonNull final Cursor log) {
        ...
        private static final class HoursGroup {
             ...
             * @param what0 argument
             */
            private HoursGroup(@NonNull final ContentResolver cr, final long what0) {
                final Cursor cursor = cr.query(
    ...
    private static class Plan {
         ...
         * @param cursor {@link Cursor}
         */
        Plan(final ContentResolver cr, @NonNull final Cursor cursor) {
            cResolver = cr;
         ...
         */
        float getBilledAmount(@NonNull final Cursor log) {
